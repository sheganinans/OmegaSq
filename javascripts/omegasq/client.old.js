...
omegasq.objects = cljs.core.PersistentVector.fromArray([omegasq.kmesh1,omegasq.kmesh2,omegasq.kmesh3,omegasq.cmesh1,omegasq.cmesh2,omegasq.cmesh3,omegasq.cmesh4,omegasq.cmesh5,omegasq.cmesh6,omegasq.cmesh7], true);
...
var objs_3240 = omegasq.objects;
while(true){
if(!(cljs.core.empty_QMARK_.call(null,objs_3240)))
{omegasq.add_to_scene.call(null,cljs.core.first.call(null,objs_3240));
{
var G__3241 = cljs.core.rest.call(null,objs_3240);
objs_3240 = G__3241;
continue;
}
} else
