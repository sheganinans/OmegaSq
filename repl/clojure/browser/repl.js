...
var temp__4009__auto__ = cljs.core.deref.call(null,clojure.browser.repl.xpc_connection);
if(cljs.core.truth_(temp__4009__auto__))
{var conn = temp__4009__auto__;
...
}catch (e4849){if(cljs.core.instance_QMARK_.call(null,Error,e4849))
{var e = e4849;
...
var temp__4009__auto__ = clojure.browser.net.xpc_connection.call(null);
if(cljs.core.truth_(temp__4009__auto__))
{var repl_connection = temp__4009__auto__;
